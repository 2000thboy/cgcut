...
if ($pipCheck) {
    ...
    Write-Host "[ERROR] Pip not installed, skipping installation (please install manually)" -ForegroundColor Red
}

# If all base environments are installed, install project dependencies
if ($nodeCheck -and $npmCheck -and $pythonOk -and $pipCheck) {
